...
//                exportService.printDuration(verystarttime, "Overall Time")
    ...
    def private processFinancialCSV(out, result, header) {
        ...
        out.withWriter { writer ->
            ...
            if ( header ) {
                writer.write("Institution,Generated By,Generated Date,Cost Item Count\n")
                writer.write("${result.institution.name?:''},${result.user.username},${dateFormat.format(generation_start)},${result.cost_item_count}\n")
            }
