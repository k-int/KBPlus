...
class LicenseDetailsController {
  ...
  def history() {
    ...
    def qry_params = [licClass:result.license.class.name, prop:LicenseCustomProperty.class.name,licProps:result.license.customProperties.collect{it.id.toString()}, licId:"${result.license.id}"]
