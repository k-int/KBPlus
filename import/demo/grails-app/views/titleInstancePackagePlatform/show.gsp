				...
				<dl>
					...
					<g:if test="${titleInstancePackagePlatformInstance?.pkg}">
						<dt><g:message code="titleInstancePackagePlatform.pkg.label" default="Pkg" /></dt>
							...
							<dd><g:link controller="package" action="show" id="${titleInstancePackagePlatformInstance?.pkg?.id}">${titleInstancePackagePlatformInstance?.pkg?.encodeAsHTML()}</g:link></dd>
					...
					<g:if test="${titleInstancePackagePlatformInstance?.platform}">
						<dt><g:message code="titleInstancePackagePlatform.platform.label" default="Platform" /></dt>
							...
							<dd><g:link controller="platform" action="show" id="${titleInstancePackagePlatformInstance?.platform?.id}">${titleInstancePackagePlatformInstance?.platform?.encodeAsHTML()}</g:link></dd>
					...
					<g:if test="${titleInstancePackagePlatformInstance?.title}">
						<dt><g:message code="titleInstancePackagePlatform.title.label" default="Title" /></dt>
							...
							<dd><g:link controller="titleInstance" action="show" id="${titleInstancePackagePlatformInstance?.title?.id}">${titleInstancePackagePlatformInstance?.title?.encodeAsHTML()}</g:link></dd>
